        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-600">
              Revisa los avisos relacionados con tus reservas y cambios de estado.
            </p>
          </div>
        ...
        {cargando ? (
          ...
          <div className="rounded-3xl bg-white p-10 text-center shadow-sm">
            ...
            <p className="mt-2 text-slate-500">
              Cuando crees, canceles o cambie el estado de una reserva, los avisos aparecerán aquí.
            </p>
                ...
                <div className="space-y-3">
                  {notificacionesNoLeidas.map((item) => (
                    <CardNotificacion
                      ...
                      notificacion={item}
                      procesando={procesando === item.id_notificacion}
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        {!notificacion.leida && (
          <button
            ...
            disabled={procesando}
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 py-2 text-xs font-bold text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
            <CheckCheck size={15} />
            {procesando ? "Marcando..." : "Marcar leída"}
          </button>
        )}
      </div>
    </article>
